...
(function ($) {
    ...
    $.validator.config({
        ...
        rules: {
            digits: [/^\d+$/, "请输入整数"]
			,dot: [/^\d{1,4}(?:\.\d{0,2})?$/, "请输入数字,小数点后最多保留两位"]//新增的小数支持
            ,letters: [/^[a-z]+$/i, "{0}只能输入字母"]
            ,tel: [/^(?:(?:0\d{2,3}[- ]?[1-9]\d{6,7})|(?:[48]00[- ]?[1-9]\d{6}))$/, "电话格式不正确"]
            ,mobile: [/^(13[0-9]|15[012356789]|18[0236789]|14[57])[0-9]{8}$/, "手机号格式不正确"]
            ...
            ,className:[/^[0-9a-zA-Z\u0391-\uFFE5]{1,10}$/, "类别名称由1-10字符组成,不含特殊符号"]
    		,webName:[/^[0-9a-zA-Z\u0391-\uFFE5]{1,10}$/, "网站名称由1-10字符组成,不含特殊符号"]
